...
def Solver_TwoModesCoupledToMR_2(N,wr,kappa_a,kappa_b,gamma,n_th_r,Ea,Eb,galist,Delta_a_list):
    """
    This functions solves the steady-state for a system of two EM modes,
    A and B, coupled to single mechanical mode R, for different values of
    detunings Delta_a and Delta_b.
...
def Solver_TwoModesCoupledToMR_3(N,wr,kappa_a,kappa_b,gamma,n_th_r,Ea,Eb,galist,Delta_a_list):
    """
    This functions solves the steady-state for a system of two EM modes,
    A and B, coupled to single mechanical mode R, for different values of
    driver strength E_a and driver detuning Delta_a.
...
def Solver_TwoModesCoupledToMR_4(N,wr,kappa_a,kappa_b,gamma,n_th_r,Ea,Eb,galist,Delta_a_list):
    """
    This functions solves the steady-state for a system of two EM modes,
    A and B, coupled to single mechanical mode R, for different values of
    driving strength E_b and driver detuning Delta_a.
